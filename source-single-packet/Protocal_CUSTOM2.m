classdef Protocal_CUSTOM2 < Protocal
    ...
    methods(Access = public)
        function obj = Protocal_CUSTOM2(argTopo)
        ...
        function forwardPacket(obj)
            if obj.timer.time == 0
                ...
                obj.matQualityMetric = (1 - obj.topology.matRSSI ./ max(obj.topology.matRSSI(:))).^lambda ...
                                          ...
                                          + (obj.topology.matSNR ./ max(obj.topology.matSNR(:))).^gamma;        
...
%                     ETX = obj.matETX(senderIndex, receiverIndex(i));
                    ...
                    beta  = 0.1;
                    gamma = 0.7;
                    routeCost =  (alpha * MHCmax / hopNumber ...
        ...
        function updateQualityMetric(obj, sender, k)
            ...
            path = shortestpathM(obj.topology.route, sender.index, obj.topology.nodeSinkIndex);
